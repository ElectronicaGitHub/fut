...
module.exports = function(options){
  ...
  login.prototype.keepAlive = function(xsrfValue, cb) {
    ...
    defaultRequest.get(urls.keepAlive, function (err, response, body) {
      console.log('login::session keeped alive');
      cb && cb(response);
    })
  }
  ...
  function phishing(noCb, customCb) {
    ...
    defaultRequest.get(urls.login.question, function (error, response, body) {
        ...
        if(utils.isApiMessage(body) && body.token) {
            ...
            console.log('get phishing', loginResponse.token);
